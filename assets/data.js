...
addItem(4000, 'miningRig', 'Mining Rig', 50000, {
	'storageLimit' : 1
}).setCraftingCost([ [ Items.dirt.id, 100 ] ]);
...
}).setCraftingCost([ [ Items.copperBar.id, 10 ] ]);

addItem(40002, 'ironPick', 'Iron Pickaxe', 25, {
	'storageLimit' : 1
}).setCraftingCost([ [ Items.ironBar.id, 10 ] ]);

addItem(40003, 'goldPick', 'Gold Pickaxe', 2500, {
	'storageLimit' : 1
}).setCraftingCost([ [ Items.goldBar.id, 10 ] ]);

addItem(40004, 'jackhammer', 'Jackhammer', 10000, {
	'storageLimit' : 1
}).setCraftingCost(
		[ [ Items.ironBar.id, 50 ], [ Items.fuelCan.id, 50 ],
				[ Items.goldBar.id, 10 ] ]);
...
addItem(42000, 'copperHelmet', 'Copper Helmet', 5, {
	'storageLimit' : 1
}).setCraftingCost([ [ Items.copperBar.id, 4 ] ]);
...
addItem(43000, 'copperArmor', 'Copper Armor', 5, {
	'storageLimit' : 1
}).setCraftingCost([ [ Items.copperBar.id, 8 ] ]);
...
addItem(44000, 'copperArmorLegs', 'Copper Legs', 5, {
	'storageLimit' : 1
}).setCraftingCost([ [ Items.copperBar.id, 6 ] ]);
...
addItem(45000, 'copperArmorFeet', 'Copper Boots', 5, {
	'storageLimit' : 1
}).setCraftingCost([ [ Items.copperBar.id, 3 ] ]);
